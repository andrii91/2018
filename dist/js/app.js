...
//            nav:false
  ...
  $('.reviews .item').click(function() {
    $('#reviews iframe').attr('src', 'https://www.youtube.com/embed/' + $(this).data('link_id') + '/?autoplay=1');
  });
...
$('.overlay, #reviews_all .popup__close').click(function () {
    $('#reviews_all iframe').attr('src', 'https://www.youtube.com/embed/videoseries?list=PL5a38cCDPUC1eXY88N7pvmYq29kJcJUPB');
  });
